...
annotate_figure(plt, top = text_grob("Score Distribution for Winning and Losing Teams", face = "bold", size = 12))
```
...
plt <- ggarrange(wscore, lscore, ncol = 1, nrow = 2)
annotate_figure(plt, top = text_grob("eFG% Distribution for Winning and Losing Teams", face = "bold", size = 12))
...
annotate_figure(plt, top = text_grob("Assist Distribution for Winning and Losing Teams", face = "bold", size = 12))
```
...
plt <- ggarrange(w, l, ncol = 1, nrow = 2)
annotate_figure(plt, top = text_grob("Rebound Distribution for Winning and Losing Teams", face = "bold", size = 12))
```
...
plt <- ggarrange(w, l, ncol = 1, nrow = 2)
annotate_figure(plt, top = text_grob("Turnover Distribution for Winning and Losing Teams", face = "bold", size = 12))
```
...
```{r}
mod_max <- glm(HomeWin ~ Home_eFG + Away_eFG + Home_R + Away_R + Home_Ast + Away_Ast + TO_diff + FGM_diff + eFG_pct_ratio, 
               family = binomial(), 
               data = wbb_subset)
summary(mod_max)
